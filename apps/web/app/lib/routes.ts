const protectedPaths = new Set(["/dashboard", "/console", "/logs", "/settings", "/users", "/cfg-editor", "/backups", "/backups/manual", "/backups/automatic", "/wipes", "/wipes/custom", "/wipes/history"]);
